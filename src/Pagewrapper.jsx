...
export const Pagewrapper = (props) => {
    return (
        <div>
            ...
            {/*end of preloading*/}
            {/*login form popup*/}     <div className="login-wrapper" id="login-content">
            ...
            {/*end of login form popup*/}     {/*signup form popup*/}     <div className="login-wrapper" id="signup-content">
                <div className="login-content">
                    <a href="#" className="close">x</a>
                    <h3>sign up</h3>
                    <form method="post" action="#">
            ...
            {/*end of signup form popup*/}      {/* BEGIN | Header */}     <header className="ht-header">
                <div className="container">
                    <nav className="navbar navbar-default navbar-custom">
                        {/* Brand and toggle get grouped for better mobile display */}           <div className="navbar-header logo">
                        ...
                        {/* Collect the nav links, forms, and other content for toggling */}           <div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
                    ...
                    {/* top search form */}         <div className="top-search">
                        <select>
            ...
            {/* END | Header */}      <div className="hero common-hero">
                <div className="container">
                    <div className="row">
                            ...
                            <div className="sidebar">
                                ...
                                <div className="sb-twitter sb-it">
                                    ...
                                    <div className="slick-tw">
                                        <div className="tweet item" id="">{/* Put your twiter id here */}                   </div>
                                        <div className="tweet item" id="">{/* Put your 2nd twiter account id here */}                   </div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {/* footer section*/} <footer className="ht-footer">
                <div className="container">
